...
import { CheckCircle2, ArrowRight, ShoppingBag } from "@/lib/icons";
      ...
      <div className="max-w-3xl w-full text-center space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <p className="text-slate-500 text-lg">Your demo order has been placed successfully.</p>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-6 text-left">
          <div className="bg-white border border-slate-200 rounded-3xl p-6 shadow-sm space-y-4">
            ...
            <div className="space-y-3 text-sm text-slate-600 leading-relaxed">
              <p>This is a demo-only checkout flow built for client presentation.</p>
              <p>No payment provider is connected.</p>
            </div>
          </div>
          ...
          <div className="bg-white border border-slate-200 rounded-3xl p-6 shadow-sm space-y-6">
            <div className="space-y-2">
              ...
              <p className="text-lg font-black text-slate-900">{formatOrderId(orderId)}</p>
            </div>
            <div className="space-y-2">
              <h3 className="text-sm font-bold uppercase tracking-widest text-slate-400">Status</h3>
              <p className="text-sm text-slate-600 font-medium">Order received and queued for demo fulfillment.</p>
            </div>
          </div>
        </div>
